    ...
    return (
        <>
            ...
            <main className="mx-auto min-h-[calc(100vh-56px)] w-[min(1180px,calc(100%-40px))] grid content-center gap-12 py-14 pb-24">
                ...
                <section id="latest" className="mx-auto grid w-[min(980px,100%)] overflow-hidden rounded-10 border border-[var(--line)] bg-[var(--surface)] shadow-[var(--shadow),inset_0_1px_rgba(255,255,255,.45)] backdrop-blur-2xl md:grid-cols-[0.48fr_0.52fr]" aria-label="最新一期周刊">
                    <a className="min-h-58 overflow-hidden bg-[var(--surface-soft)] md:min-h-82.5" href="#latest" aria-label={`阅读第 ${latestIssue.number} 期`}>
                    ...
                    <div className="flex flex-col justify-center p-6 md:p-14.5">
                        ...
                        <p className="mb-6 text-[var(--muted)]">{latestIssue.summary}</p>
